...
cp ~/gcs-config/config-apache.sh /var/lib/jenkins/config-apache.sh
chmod +x /var/lib/jenkins/build.sh /var/lib/jenkins/teste.sh /var/lib/jenkins/destroy-build.sh /var/lib/jenkins/config-apache.sh
